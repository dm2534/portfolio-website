...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden font-sans bg-[#0d1117] bg-[radial-gradient(ellipse_80%_60%_at_70%_20%,#1a2540_0%,#0d1117_55%),radial-gradient(ellipse_50%_40%_at_20%_80%,#1c1810_0%,transparent_60%)]">
      {/* Subtle grid texture */}
      ...
      {/* Hero */}
      <main className="relative z-10 grid md:grid-cols-2 gap-0 min-h-[calc(100vh-88px)] px-10 pb-10">
        {/* Left — Bio */}
        <div className="flex flex-col justify-center pr-0 md:pr-16 py-12 md:py-0 order-2 md:order-1">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <button className="px-7 py-3 text-[13px] tracking-widest uppercase transition-all duration-200 bg-[#c9a96e] text-[#0d1117] hover:bg-[#d4b87e]">
              View Work
            </button>
            <button className="px-7 py-3 text-[13px] tracking-widest uppercase border border-[#c9a96e]/30 text-[#c9a96e] transition-all duration-200 hover:bg-[#c9a96e]/10">
              Get in Touch
            </button>
          </div>
        </div>
